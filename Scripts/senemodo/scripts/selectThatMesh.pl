...
#(2-2-13 fix) : fixed the bug that would occur if you clicked on a trisurf.
#(2-14-14 fix) : i was originally deselecting clips but i don't remember why so i commented that out because it was annoying when uving and you'd have to reselect the clip again to see where you're trying to place your uvs...
...
if ($itemType eq "meshInst"){
	while (1){
		...
		if ($newSelItemType ne "meshInst"){last;}
	}
