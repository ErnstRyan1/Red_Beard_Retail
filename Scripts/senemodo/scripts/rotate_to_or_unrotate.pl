...
#(10-121-15 fix) : the user variable i store the rotation to was using a "temporary" lifespan which dies the second the script is completed which is pointless.  so i changed it to "temporary" so it stays until you close the app
...
#=====================================================================================================================================
#=====================================================================================================================================
#create the sene_rotToObjHistory variable if it didn't already exist.
